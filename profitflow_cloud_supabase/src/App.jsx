...
function publicPaymentSettings(paymentSettings){
  return {
    paypal_email: paymentSettings?.paypal_email || GLOBAL_PAYMENT_SETTINGS.paypal_email,
    paypal_link: paymentSettings?.paypal_link || GLOBAL_PAYMENT_SETTINGS.paypal_link,
    account_name: paymentSettings?.account_name || GLOBAL_PAYMENT_SETTINGS.account_name,
    bank_name: paymentSettings?.bank_name || GLOBAL_PAYMENT_SETTINGS.bank_name,
    sort_code: paymentSettings?.sort_code || GLOBAL_PAYMENT_SETTINGS.sort_code,
    account_number: paymentSettings?.account_number || GLOBAL_PAYMENT_SETTINGS.account_number
  };
}
